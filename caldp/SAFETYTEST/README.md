...
```
$ curl -O https://ssb.stsci.edu/releases/caldp/SAFETYTEST/latest-linux.yml
$ conda env create -n caldp_SAFETYTEST --file latest-linux.yml
```
### Activate the pipeline environment

```
$ source activate caldp_SAFETYTEST
```
