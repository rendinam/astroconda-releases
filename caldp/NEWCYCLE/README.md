...
```
$ curl -O https://ssb.stsci.edu/releases/caldp/NEWCYCLE/latest-linux.yml
$ conda env create -n caldp_NEWCYCLE --file latest-linux.yml
```
### Activate the pipeline environment

```
$ source activate caldp_NEWCYCLE
```
