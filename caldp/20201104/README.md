...
```
$ curl -O https://ssb.stsci.edu/releases/caldp/20201104/latest-linux.yml
$ conda env create -n caldp_20201104 --file latest-linux.yml
```
### Activate the pipeline environment

```
$ source activate caldp_20201104
```
