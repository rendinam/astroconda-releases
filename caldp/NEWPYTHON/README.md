...
```
$ curl -O https://ssb.stsci.edu/releases/caldp/NEWPYTHON/latest-linux.yml
$ conda env create -n caldp_NEWPYTHON --file latest-linux.yml
```
### Activate the pipeline environment

```
$ source activate caldp_NEWPYTHON
```
