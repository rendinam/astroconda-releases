...
```
$ curl -O https://ssb.stsci.edu/releases/caldp/TESTNAME/latest-linux.yml
$ conda env create -n caldp_TESTNAME --file latest-linux.yml
```
### Activate the pipeline environment

```
$ source activate caldp_TESTNAME
```
